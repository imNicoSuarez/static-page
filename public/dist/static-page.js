...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  function App() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(App)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handlerInrementa = function (event) {
	      _reducer2.default.dispatch({ type: 'INCREMENT' });
	    }, _this.handlerDecrementa = function (event) {
	      _reducer2.default.dispatch({ type: 'DECREMENT' });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          null,
	          'Hola ',
	          _reducer2.default.getState()
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.handlerInrementa },
	          '+'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.handlerDecrementa },
	          '-'
	        )
	      );
	    }
	...
	render();
	_reducer2.default.subscribe(render);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(173)(global || window || undefined);
